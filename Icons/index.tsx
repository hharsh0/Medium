...
export const Medium = () => {
  return (
    <svg viewBox="0 0 1043.63 592.71" className="h-12 w-12">
      <g data-name="Layer 2">
        <g data-name="Layer 1">
...
export const Write = ()=>{
    return (
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className="w-6 h-6 hover:text-stone-950"
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
...
export const More = ()=>{
    return (
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className="w-6 h-6 hover:text-stone-950 cursor-pointer"
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
...
export const SaveB = ()=>{
    return (
      <svg
        viewBox="0 0 24 24"
        fill="none"
        className="h-6 w-6 cursor-pointer hover:text-stone-950"
      >
        <path
